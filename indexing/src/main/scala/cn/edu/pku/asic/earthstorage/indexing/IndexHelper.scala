...
import cn.edu.pku.asic.earthstorage.common.cg.SpatialDataTypes.{JavaPartitionedSpatialRDD, JavaSpatialRDD, PartitionedSpatialRDD, SpatialRDD}
import cn.edu.pku.asic.earthstorage.common.cg.{SparkSpatialPartitioner, SpatialPartitioner}
import cn.edu.pku.asic.earthstorage.common.cli.{AppOptions, OperationHelper, OperationParam}
import cn.edu.pku.asic.earthstorage.common.geolite.{EnvelopeNDLite, IFeature, PointND}
import cn.edu.pku.asic.earthstorage.common.io.SpatialOutputFormat
...
//import org.apache.spark.rdd.LocalRDDCheckpointData.DEFAULT_STORAGE_LEVEL.description
...
//  private[beast] def summarizeDataset(features: SpatialRDD, partitionerClass: Class[_ <: SpatialPartitioner],
  private def summarizeDataset(features: SpatialRDD, partitionerClass: Class[_ <: SpatialPartitioner],
    ...
    import cn.edu.pku.asic.earthstorage.common.cg.CGOperationsMixin._
...
//  private[beast] def runDuplicateAvoidance(features: SpatialRDD): SpatialRDD = {
  ...
  lazy val partitioners: Map[String, Class[_ <: SpatialPartitioner]] = {
    ...
    val partitionerClasses: java.util.List[String] = OperationHelper.readConfigurationXML("earthstorage.xml").get("SpatialPartitioners")
